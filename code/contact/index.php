...
<head>
  ...
  <!-- /content Header Object -->
  <!-- Google Analytics -->
  <script src="../js/global/ga.js"></script>
  <!-- /Google Analytics -->
</head>
...
<body class="form">
          ...
          <div class="contentBody">
            <form action="#" class="orderForm form-inline" id="orderForm" method="POST">
              ...
              <div class="row lineForm mT15">
                ...
                <div class="col-md-3">
                  <div class="wrapCheckmart">
                    <label class="multi">11/17<input type="checkbox" value="" /><span class="checkmark"></span></label>
                ...
                <div class="col-md-10">
                  <div class="wrapCheckmart">
                    <label class="unset">貴方の願い、設計のプロが叶えます！
                      ...
                      捨てるが苦手な人も<input type="checkbox" value="" name="input10"/><span class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">広さに頼らない「心地よい住まい」のつくり方<input type="checkbox" value="" name="input101" /><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">安心安全に暮らす 神奈川県の防災対策と対処法<input type="checkbox" value="" name="input102"/><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">「美人収納」 捨てるが苦手な人もできる仕分け術<input type="checkbox" value="" name="input103"/><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">元号、消費税の変化に伴い、抑えておきたいお金の話！<input type="checkbox" value="" name="input104"/><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">実質金利ゼロ!?
                      住宅ローン&家計で2,000万節約するマル秘テクニック<input type="checkbox" value="" name="input105"/><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">災害に強い安心・安全な住まいとは<input type="checkbox" value="" name="input105"/><span
                        class="checkmark"></span></label>
                  </div>
                  <div class="wrapCheckmart">
                    <label class="unset">相続・贈与時の お得な減税制度とは<input type="checkbox" value="" name="input106"/><span
                        class="checkmark"></span></label>
                  </div>
                </div>
              </div>
              <div class="row lineForm mT15 form11">
                <div class="col-md-2">
                  <h2>
                    <ruby>託児所利用 <rt class="brown">任意 </rt>
                      <rt> </rt>
                    </ruby>
                  </h2>
                </div>
                <div class="col-md-10">
                  <div class="lineFormchild">
                    <div class="wrapCheckmart">
                      <label class="unset">利用する<input type="checkbox" value="" name="input11" /><span class="checkmark"></span></label>
                    </div>
                  </div>
                  <div class="row ml--15">
              ...
              <div class="row mT15 form12">
                ...
                <div class="col-md-10">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">住友林業<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">セキスイハイム<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">ダイワハウス <input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">パナソニック ホームズ<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">へーベルハウス<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">ミサワホーム<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
                  ...
                  <div class="row mT20 ml--15">
                    <div class="form-group col-md-4">
                      <div class="wrapCheckmart">
                        <label class="unset">三井ホーム<input type="checkbox" value="" /><span
                            class="checkmark"></span></label>
                      </div>
                    </div>
                    <div class="col-md-1">
  ...
  <script src="../js/content/drink.js"></script>
  <!-- /content Header Object -->
</body>
