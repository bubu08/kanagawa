...
$mail->Host       = "kanagawaselect8.sakura.ne.jp";
$mail->Port       = 587; // or 587
$mail->IsHTML( true );
$mail->Username = "test@kanagawaselect8.jp";
$mail->Password = "uV7KvsCH6mu";
$mail->SetFrom( "test@kanagawaselect8.jp" );
...
$mail->Subject = "{$mail_title}ホームページの『お問い合わせ』より送信";
...
$mail->AddAddress( "thang.pham@365dep.vn" );
